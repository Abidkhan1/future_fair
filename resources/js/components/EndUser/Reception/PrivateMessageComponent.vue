<template>
   <div >
      <!-- template for video chat component -->

      <template v-if="get_access">
      <div class="right1">
         <div class="top1">
...
<script>
// import VideoChat from './Staff/VideoChat/VideoChatComponent'
// import MessageLog from './Staff/VideoChat/MessageLogComponent'
export default {
   props: ['friend'],
   data() {
      return {
