      ...
      <form class="form-horizontal">
        <div class="card-body">
         ...
         <div class="card-footer">
          <button type="button" class="btn btn-info" @click.prevent="addOffer">Save</button>
...
<script>
    ...
    export default {props:['id'],
        ...
        mounted() {
            axios.get(APP_URL+`offer/${this.id}`).then(res=>{
              console.log('response :',res.data);
                this.title = res.data.offer.title;
                this.description = res.data.offer.description;
                this.start_time = res.data.offer.start_time;
                this.end_time = res.data.offer.end_time;
        ...
        methods:{
            addOffer(){
                axios.put(APP_URL+'offer/'+this.id,{
                    title:this.title,
