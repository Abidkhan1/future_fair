        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                <label>CNIC#</label>
                <input type="text" class="form-control" id="cnic" placeholder="xxxxxxxxxxxxx" v-model:value="cnic">
         ...
         <div class="card-footer">
          <button type="button" class="btn btn-info" @click.prevent="addStaff">Add</button>
